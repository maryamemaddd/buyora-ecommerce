...
export const TopBanner = () => {
    ...
    const promos = [
        <div key="1" className="flex items-center gap-2 sm:gap-3 mx-4 sm:mx-8">
            <span className="text-base sm:text-xl">🎁</span>
            <span>Free Shipping on orders over <span className="text-amber-400 font-bold">$100</span></span>
        </div>,
        <div key="2" className="flex items-center gap-2 sm:gap-3 mx-4 sm:mx-8">
            <span className="text-base sm:text-xl glow-star">⭐</span>
            <span>Premium 24/7 Customer Support</span>
        </div>,
        <div key="3" className="flex items-center gap-2 sm:gap-3 mx-4 sm:mx-8">
            <span className="text-base sm:text-xl">🔥</span>
            <span>Limited Time Offers <span className="text-pink-400 font-bold">Up to 40% OFF</span></span>
        </div>,
        <div key="4" className="flex items-center gap-2 sm:gap-3 mx-4 sm:mx-8">
            <span className="text-base sm:text-xl">💎</span>
    ...
    return (
        <div className="w-full bg-[#050510] text-[#f8fafc] overflow-hidden py-2 sm:py-2.5 border-b border-white/10 z-[100] relative drop-shadow-2xl">
            {/* The wrapper must explicitly contain the width of its contents. */}
            <div className="flex whitespace-nowrap overflow-hidden">
                <div className="animate-ticker text-xs sm:text-sm font-semibold tracking-wider text-gray-200">
                    {/* First iteration */}
                    {promos}
