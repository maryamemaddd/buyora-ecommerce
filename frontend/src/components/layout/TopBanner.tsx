...
export const TopBanner = () => {
    ...
    return (
        <div className="w-full bg-[#050510] text-[#f8fafc] overflow-hidden py-3 border-b border-white/10 z-[100] relative drop-shadow-2xl">
            {/* The wrapper must explicitly contain the width of its contents. */}
            <div className="flex whitespace-nowrap overflow-hidden">
                <div className="animate-ticker text-sm md:text-base font-semibold tracking-wider text-gray-200">
                    {/* First iteration */}
                    {promos}
