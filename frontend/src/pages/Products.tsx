    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8 animate-fade-in relative z-10">
            ...
            <div className="lg:hidden flex items-center justify-between mb-4">
                <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100">{currentCategory ? currentCategory : 'Shop All'}</h1>
                <button
      ...
      `}>
            ...
            <div className="flex-1 pb-16">
                <div className="hidden lg:flex items-end justify-between mb-8 pb-4 border-b border-gray-200/50 dark:border-gray-700/50">
                    <h1 className="text-3xl lg:text-4xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-500 dark:from-slate-100 dark:to-gray-500">{currentCategory ? currentCategory : 'The Collection'}</h1>
